...
public static class RouteHandlerBuilderExtensions
{
    public static RouteHandlerBuilder RequireRoles(this RouteHandlerBuilder builder, params UserRole[] roles)
    {
        ...
        // ClaimTypes.Role resolves to "http://schemas.microsoft.com/ws/2008/06/identity/claims/role"
        return builder.RequireAuthorization(policy => policy.RequireClaim(ClaimTypes.Role, roleNames));
    }
